...
<module external.linked.project.id=":react-native-modbus-tcp" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../example/android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":react-native-modbus-tcp" />
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: __local_aars__:C.\Users\sesa557347\Desktop\react-library\react-native-modbus-tcp\android\libs\modbus4Android-1.2.jar:unspecified@jar" level="project" />
