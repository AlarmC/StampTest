...
import music from '../../../assets/music/musicImg';
...
const MusicCanvas = () => {
    ...
    return (
        <>
            ...
            <>
                <hr></hr>
                <div className={style.dot_menu_title}>음악 도장</div>
                <div className={style.dot_shape_div} style={{height: "300px"}}>
                    <Scrollbars thumbsize={125}>
                        <img src={music.img1} onClick={() => setTestShape(music.img1)} />
                        <img src={music.img2} onClick={() => setTestShape(music.img2)} />
                        <img src={music.img3} onClick={() => setTestShape(music.img3)} />
                        <img src={music.img4} onClick={() => setTestShape(music.img4)} />
                        <img src={music.img5} onClick={() => setTestShape(music.img5)} />
                        <img src={music.img6} onClick={() => setTestShape(music.img6)} />
                        <img src={music.img7} onClick={() => setTestShape(music.img7)} />
                        {/* <img src={music.img8} onClick={() => setTestShape(music.img8)} /> */}
                    </Scrollbars>
                </div>
