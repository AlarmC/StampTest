...
const TextKonva = ({showSize, family, fontsize, fontdata, fontcolor, fontstroke, fontsys, curveBool, curveOption}) => {
    ...
    const DrawCurvedText = () => {
        ...
        let radius = showSize/2 - fontsize;
    ...
    return (
        <div className={style.stamp_text} style={{margin:"125px"}}>
